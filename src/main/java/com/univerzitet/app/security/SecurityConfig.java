    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authz -> authz
            		...
            		.requestMatchers(HttpMethod.DELETE, "/api/registrovaniKorisnici/{id}").permitAll()
            		.requestMatchers(HttpMethod.GET, "/api/registrovaniKorisnici/").hasAuthority("ROLE_ADMIN")
            		.requestMatchers(HttpMethod.POST, "/api/registrovaniKorisnici/osoblje").hasAuthority("ROLE_ADMIN")
            		...
            		.requestMatchers(HttpMethod.GET, "/api/programi").permitAll()
            		.requestMatchers(HttpMethod.GET, "/api/programi/{id}").permitAll()
            		.requestMatchers(HttpMethod.POST, "/api/programi/kreiraj").hasAuthority("ROLE_ADMIN")
            		.requestMatchers(HttpMethod.PUT, "/api/programi/{id}").hasAuthority("ROLE_ADMIN")
            		.requestMatchers(HttpMethod.DELETE, "/api/programi/{id}").hasAuthority("ROLE_ADMIN")
            		...
            		.requestMatchers(HttpMethod.GET, "/api/studenti/{id}").permitAll()
            		.requestMatchers(HttpMethod.POST, "/api/studenti/kreiraj").hasAuthority("ROLE_OSOBLJE")
